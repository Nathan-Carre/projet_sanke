...
def perduhahatnul():
    ...
    replay=tk.Button(text="Rejouer", fg="white", bg="black", relief="raised", font=("Lucida Console","20"),command= rejouer )
    ...
    sortir=tk.Button(text="Quitter le jeu", fg="white", bg="black", relief="raised", font=("Lucida Console","20"), command=quitter)
    sortir.place(x= WIDTH//2.81,y=HEIGHT//1.3)
    save_score()
...
def getPanScore():
    ...
    return panScore
#adi############j'ai essayer de faire de la fonction perduhahatnul un pannel########
"""def getPanPerdu():
    
    replay=tk.Button(text="Rejouer", fg="white", bg="black", relief="raised", font=("Lucida Console","20"),command=lambda: switchPan(getPanJeu()) )
    replay.place(x= WIDTH//2.4,y=HEIGHT//2)
    backto=tk.Button(text="Revenir au menu", fg="white", bg="black", relief="raised", font=("Lucida Console","20"), command=lambda: switchPan(getPanMenu()) )
    backto.place(x= WIDTH//3,y=HEIGHT//1.7)

    panPerdu = tk.Frame(snake, bg=couleurFond)
    env_jeu =tk.Canvas(panPerdu,width=WIDTH, heigh=HEIGHT, bg=couleurFond) 
    env_jeu.pack()
    perduhahatnul()
...
#j'ai donc mis rejouer hors de la fontion getPanPerdu() et conserver perduhahatnul#
#def getPanPerdu():
